            ...
            <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div class="col-half">
                    ...
                    <input required type="file" accept=".jpeg,.jpg,.png,.gif" class="form-control blue-border" data-testid="file" />
                  </div>
                  <p class="hidden" data-testid="warning">Format de fichier incompatible</p>
                </div>
            </div>
            <div class="row">
              <div class="col-md-6">
